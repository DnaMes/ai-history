...
``lore.services`` (issue #47). The functions here are thin
...
Re-exports from ``lore.services`` keep the historical
...
from lore.services.index import (
...
from lore.utils.paths import lore_home
