...
interface (``ai_history.interfaces.web``) and the MCP server
(``ai_history.interfaces.mcp``) depend on.
...
Nothing in this package may import Flask or any ``ai_history.interfaces``
module.
"""
